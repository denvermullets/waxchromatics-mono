...
export default class extends Controller {
  ...
  select(event) {
    ...
    this.containerTarget.insertAdjacentHTML("beforeend", this.buildCard(rgId, rgTitle, rgYear, rgCover))
  ...
  buildCard(id, title, year, cover) {
    ...
    return `<div data-rg-card="${id}" class="p-4 rounded-lg border border-woodsmoke-700 bg-woodsmoke-925 flex items-start gap-4">
