...
ActiveRecord::Schema[8.1].define(version: 20_260_227_120_000) do
  ...
  create_table 'collection_items', force: :cascade do |t|
    ...
    t.string 'status'
    t.datetime 'updated_at', null: false
    t.index %w[collection_id release_id], name: 'index_collection_items_on_collection_id_and_release_id'
  ...
  create_table 'connection_caches', force: :cascade do |t|
    t.bigint 'artist_a_id', null: false
    t.bigint 'artist_b_id', null: false
    t.datetime 'created_at', null: false
    t.integer 'degrees'
    t.boolean 'found', default: false, null: false
    t.jsonb 'path_data', default: [], null: false
    t.datetime 'updated_at', null: false
    t.index %w[artist_a_id artist_b_id], name: 'index_connection_caches_on_artist_a_id_and_artist_b_id', unique: true
    t.index ['artist_a_id'], name: 'index_connection_caches_on_artist_a_id'
    t.index ['artist_b_id'], name: 'index_connection_caches_on_artist_b_id'
  end
  ...
  create_table 'pending_ingests', force: :cascade do |t|
    ...
    t.string 'status', default: 'pending', null: false
    t.datetime 'updated_at', null: false
    t.index %w[discogs_id resource_type], name: 'index_pending_ingests_on_discogs_id_and_resource_type', unique: true
  end
  ...
  create_table 'ratings', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[rateable_type rateable_id reviewer_id], name: 'index_ratings_unique_per_reviewer', unique: true
    t.index %w[rateable_type rateable_id], name: 'index_ratings_on_rateable_type_and_rateable_id'
  ...
  create_table 'release_contributors', force: :cascade do |t|
    ...
    t.index %w[release_id artist_id], name: 'index_release_contributors_on_release_id_and_artist_id'
  ...
  create_table 'release_genres', force: :cascade do |t|
    ...
    t.bigint 'release_id', null: false
    t.datetime 'updated_at', null: false
    t.index %w[release_id genre], name: 'index_release_genres_on_release_id_and_genre', unique: true
  ...
  create_table 'release_identifiers', force: :cascade do |t|
    ...
    t.index %w[release_id identifier_type], name: 'index_release_identifiers_on_release_id_and_identifier_type'
  ...
  create_table 'release_labels', force: :cascade do |t|
    ...
    t.index %w[release_id label_id], name: 'index_release_labels_on_release_id_and_label_id'
  ...
  create_table 'release_styles', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[release_id style], name: 'index_release_styles_on_release_id_and_style', unique: true
  ...
  create_table 'tracks', force: :cascade do |t|
    ...
    t.string 'title'
    t.datetime 'updated_at', null: false
    t.index %w[release_id sequence], name: 'index_tracks_on_release_id_and_sequence'
  ...
  create_table 'trade_items', force: :cascade do |t|
    ...
    t.index %w[trade_id collection_item_id], name: 'index_trade_items_on_trade_id_and_collection_item_id',
                                             unique: true
  ...
  create_table 'trade_list_items', force: :cascade do |t|
    ...
    t.index %w[user_id release_id], name: 'index_trade_list_items_on_user_id_and_release_id'
  ...
  create_table 'trade_messages', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.bigint 'user_id', null: false
    t.index %w[trade_id created_at], name: 'index_trade_messages_on_trade_id_and_created_at'
  ...
  create_table 'trade_shipments', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.bigint 'user_id', null: false
    t.index %w[trade_id user_id], name: 'index_trade_shipments_on_trade_id_and_user_id', unique: true
  ...
  create_table 'trades', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[initiator_id status], name: 'index_trades_on_initiator_id_and_status'
    t.index ['initiator_id'], name: 'index_trades_on_initiator_id'
    t.index ['proposed_by_id'], name: 'index_trades_on_proposed_by_id'
    t.index %w[recipient_id status], name: 'index_trades_on_recipient_id_and_status'
  ...
  create_table 'versions', force: :cascade do |t|
    ...
    t.index %w[whodunnit item_type created_at], name: 'index_versions_on_whodunnit_item_type_created_at'
  end
  ...
  create_table 'wantlist_items', force: :cascade do |t|
    ...
    t.index %w[user_id release_id], name: 'index_wantlist_items_on_user_id_and_release_id'
  ...
  add_foreign_key 'connection_caches', 'artists', column: 'artist_a_id', on_delete: :cascade
  add_foreign_key 'connection_caches', 'artists', column: 'artist_b_id', on_delete: :cascade
